            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-14 border-b border-zinc-900 bg-zinc-950/40 backdrop-blur flex items-center justify-between px-6">
                    ...
                    <div className="flex items-center space-x-3">
                        <Link
                            href="/"
                            className="flex items-center space-x-1 px-3 py-1.5 rounded border border-zinc-900 bg-zinc-900/60 text-[10px] font-bold font-mono uppercase tracking-wider text-zinc-400 hover:text-white transition-colors"
                        >
